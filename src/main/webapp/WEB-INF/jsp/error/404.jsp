...
<head>
    ...
    <title>Pagina no encontrada · EA Taller y LubriBr</title>
...
<div style="text-align:center; max-width:420px; padding: var(--space-8);">
    <div style="font-size:3rem; font-weight:700; color: var(--color-black-800);">404</div>
    <h1 style="font-size: var(--font-size-h2); margin: var(--space-2) 0;">Pagina no encontrada</h1>
